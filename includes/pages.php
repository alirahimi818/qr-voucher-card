...
add_filter('page_template', 'qrvc_qr_code_generate_page_template');
...
add_filter('page_template', 'qrvc_bonus_profile_page_template');
...
add_filter('page_template', 'qrvc_bonus_generate_page_template');
